...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponseDTO> handleAction(ActionNotAllowedException ex, HttpServletRequest request) {
        return build(HttpStatus.CONFLICT, ErrorCode.ACTION_NOT_ALLOWED, ex.getMessage(), request, null);
    }
